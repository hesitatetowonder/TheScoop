...
function createComment(url, request){
  ...
  if(requestComment.username && requestComment.body && requestComment.articleId && database.users[requestComment.username] && database.articles[requestComment.articleId]) {
    const comment = {
